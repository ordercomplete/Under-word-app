...
### `AGENT/hooks/anti_loop.py` — детектування циклів (132 рядки, Python)
...
✅ Всі канонічні файли є в `AGENT/agents/`, `AGENT/skills/`, `AGENT/hooks/`, `.opencode/plugin/`:
- `AGENT/agents/Comfy-smart-lady.md` (169 рядків)
- 6 SKILL.md файлів у `AGENT/skills/*/`
- `AGENT/hooks/anti_loop.py` (132 рядки)
