...
//   // Шляхи - ВАЖЛИВО: sourceDir має вказувати на ПРАВИЛЬНУ папку!
//   sourceDir: "public/data", // ЗМІНИТЬ ЯКЩО ПОТРІБНО!
//   outputDir: "public/data_compressed",
...
//         fileInfo.translation === "utt" ||
//         fileInfo.translation === "ubt",
//       hasMorphology:
//         fileInfo.translation === "lxx" || fileInfo.translation === "gnt",
//       hasLemma:
//         fileInfo.translation === "lxx" || fileInfo.translation === "gnt",
...
//   const relativePath = path.relative(CONFIG.sourceDir, filePath);
//   console.log(`📖 Обробляємо: ${relativePath}`);
...
//     const emptyData = addMetadata([], fileInfo, filePath);

//     const outputPath = path.join(CONFIG.outputDir, relativePath);
//     fs.mkdirSync(path.dirname(outputPath), { recursive: true });
//     fs.writeFileSync(outputPath, JSON.stringify(emptyData));
...
//   if (fileInfo.type === "strongs") {
//     // Словники Strong - зберігаємо як є
//     convertedData = fileData;
//   } else {
//     // Переклади та оригінали
...
//   if (fileInfo.type !== "strongs" && convertedData.verses) {
...
//   const stats = { processed: 0, errors: 0, totalSize: 0, totalCompressed: 0 };
//   const items = fs.readdirSync(dirPath);
...
//  */
// async function main() {
//   console.log("🚀 ЗАПУСК КОНВЕРТАЦІЇ");
//   console.log("=".repeat(50));
//   console.log(`Джерело: ${CONFIG.sourceDir}`);
//   console.log(`Результат: ${CONFIG.outputDir}`);
//   console.log(`Виключити папки: _old, _new, backup, compressed, reports`);
//   console.log("=".repeat(50));
...
//   // Обробляємо основні директорії
//   const directories = [
//     path.join(CONFIG.sourceDir, "originals"),
//     path.join(CONFIG.sourceDir, "translations"),
//     path.join(CONFIG.sourceDir, "strongs"),
//   ];
...
//       console.log(
//         `   ✅ ${stats.processed} файлів, ❌ ${stats.errors} помилок`
//       );
...
//     } else {
//       console.log(`⚠️  Директорія не існує: ${dir}`);
//     }
//   }

//   // Обробляємо кореневі файли (core.json тощо)
//   console.log("\n📄 Обробляємо кореневі файли...");
//   const rootFiles = fs
//     .readdirSync(CONFIG.sourceDir)
//     .filter(
...
//         totalStats.totalSize += result.originalSize || 0;
//         totalStats.totalCompressed += result.compressedSize || 0;
//       } else {
//         totalStats.errors++;
//       }
//     }
...
//   // Підсумки
//   console.log("\n" + "=".repeat(50));
//   console.log("📊 ПІДСУМКИ КОНВЕРТАЦІЇ");
//   console.log("=".repeat(50));
//   console.log(`✅ Успішно: ${totalStats.processed} файлів`);
//   console.log(`❌ Помилок: ${totalStats.errors}`);

//   if (totalStats.totalSize > 0) {
//     const savings = (
//       ((totalStats.totalSize - totalStats.totalCompressed) /
//         totalStats.totalSize) *
//       100
//     ).toFixed(1);
//     console.log(
//       `📊 Розмір: ${(totalStats.totalSize / 1024 / 1024).toFixed(2)}MB → ${(
//         totalStats.totalCompressed /
//         1024 /
//         1024
//       ).toFixed(2)}MB`
//     );
