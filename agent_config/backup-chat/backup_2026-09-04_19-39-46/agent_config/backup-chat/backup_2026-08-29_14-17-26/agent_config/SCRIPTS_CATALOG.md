...
========================================================================
ЧАСТИНА III — ХУКИ В AGENT/hooks/ та їх розповсюджені копії
========================================================================

9. anti_loop.py (канон, у AGENT/hooks/)
...
10. watch_agent_file.py (канон, у AGENT/hooks/)
    Призначення: Моніторинг файлів Агента на зміни.

11. str.translate.py (канон, у AGENT/hooks/)
    Призначення: Переклад рядків інтерфейсу українською мовою.

   Розповсюджені копії:
     - .github/hooks/anti_loop.py
     - .clinerules/hooks/str.translate.py
     - .continue/hooks/Loops.json, str.translate.py
     - .opencode/hooks/str.translate.py
     - .github/hooks/watch_agent_file.py
...
========================================================================
ЧАСТИНА VI — РОЗПОВСЮДЖЕНІ СКРИПТИ ХУКІВ В .github/hooks/, .clinerules/hooks/ тощо
========================================================================

14. anti_loop.py (копія)
    Розташування: .github/hooks/anti_loop.py
    
    Використовується через плагін .opencode/plugin/anti-loop.js для перехоплення tool call'ів.

15. str.translate.py (копії у 4 місцях):
      - .github/hooks/str.translate.py
      - .clinerules/hooks/str.translate.py
      - .continue/hooks/str.translate.py
      - .opencode/hooks/str.translate.py
    
    Призначення: Переклад рядків інтерфейсу.

16. watch_agent_file.py (копія)
    Розташування: .github/hooks/watch_agent_file.py
    
    Моніторинг файлів Агента на зміни.
