// server/api.js (створіть цю папку в корені)
...
//       lines
//         .find((l) => l.includes("Файлів успішно конвертовано:"))
//         ?.match(/\d+/)?.[0] || "0";
//     const savings =
//       lines
//         .find((l) => l.includes("Загальна економія:"))
//         ?.match(/[\d.]+/)?.[0] || "0";
...
//       output: stdout.toString().substring(0, 1000), // Перші 1000 символів
