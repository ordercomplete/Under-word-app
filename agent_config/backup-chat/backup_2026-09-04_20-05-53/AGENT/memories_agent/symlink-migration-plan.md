...
|---|------------------------|---------------------|------------|-------------------|
| 1 | `AGENT/scripts/anti_loop.py` | `AGENT/scripts/anti_loop.py` | symlink | `AGENT/agents/Comfy-smart-lady.md` лінії 30–32 |
...
- [ ] Замінити `AGENT/scripts/anti_loop.py` → `AGENT/scripts/anti_loop.py` (лінії 30–32)
